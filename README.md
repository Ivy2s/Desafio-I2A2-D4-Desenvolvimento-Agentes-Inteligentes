...
O dicionário ajuda o agente a relacionar os termos da pergunta às colunas. Ele
não é contado como dataset.
...
O agente trabalha com os nomes e descrições encontrados no arquivo. Perguntas
ambíguas podem exigir que o usuário informe o dataset ou a coluna desejada.
...
As consultas E2E reais consomem quota do provedor configurado. Screenshots,
traces e resultados temporários são gravados em `frontend/test-results/`.
...
Aguarde o tempo informado pelo provedor ou use outra chave/plano. O sistema não
fabrica respostas quando o provedor bloqueia a consulta.
...
Confirme a extensão, o tamanho, o separador, o encoding, a existência de pelo
menos uma linha e a ausência de colunas ou nomes de datasets duplicados.
